...
/*Router.route("/package-listings", function(){
		this.render("packageListings");
	},
	{	name: "packageListings",
		data: function() {
...
Router.route("/postDetails", function(){
...
/*Router.route("/trip-listings", function(){
		this.render("tripListings");
	},
	{	name: "tripListings",
		data: function() {
			return {
				trips: Travels.find().fetch()
			}
		}
